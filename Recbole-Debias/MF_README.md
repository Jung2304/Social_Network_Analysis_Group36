...
### Bộ dữ liệu
Chúng tôi sử dụng các tệp atomic của bộ dữ liệu **ml-100k**. Quy trình tuân theo các bước cấu trúc sau:
1.  **Tải dữ liệu:** Các tệp tương tác atomic được tải vào môi trường RecBole.
